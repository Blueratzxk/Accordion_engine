...
#ifndef OLVP_QUERY1_HPP
#define OLVP_QUERY1_HPP
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        filterTime->addSource(tableScanLocalExchange);
        ...
        LocalExchangeNode *partialAggLocalExchange = new LocalExchangeNode("partialAggLocalExchange");
        partialAggLocalExchange->addSource(partialAgg);
        ...
        ExchangeNode *paggExchange = new ExchangeNode("schemeExchange",ExchangeNode::GATHER,schemetableScan,partialAggLocalExchange);
