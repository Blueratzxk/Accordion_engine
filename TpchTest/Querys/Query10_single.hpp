...
#ifndef OLVP_QUERY10_SINGLE_HPP
#define OLVP_QUERY10_SINGLE_HPP
...
class Query10_single:public RegQuery
{
...
public:
    ...
    LookupJoinNode *create4TJ()
    {
        ...
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,FLJFO);
        ...
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,CJN);
    ...
    LookupJoinNode *createCustomerJoinNation()
    {
        ...
        lookupJoinNode->addProbe(customer);
        lookupJoinNode->addBuild(buildExchange);
    ...
    LookupJoinNode *createFilteredLineitemJoinFilteredOrders()
    {
        ...
        lookupJoinNode->addProbe(flineitem);
        lookupJoinNode->addBuild(buildExchange);
