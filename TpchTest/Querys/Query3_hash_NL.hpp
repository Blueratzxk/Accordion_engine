...
#ifndef OLVP_QUERY3_HASH_NL_HPP
#define OLVP_QUERY3_HASH_NL_HPP


#include "../../Query/RegQuery.h"
class Query3_hash_NL:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createCustomerJoinOrders()
    {
        ...
        localExchangeOrdersTableScan->addSource(probeExchange);

        customerOrdersJoin->addProbe(probeExchange);
    ...
    LookupJoinNode *create3TJ()
    {
        ...
        shared_ptr<PartitioningScheme> schemeBuild = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_HASH_REDISTRIBUTION_BUF"),{}),outputLayout,hashColumnBuild,bucketToPartition);
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,customerJoinOrders);
        ...
        filterlineitemExchange->addSource(probeExchange);
