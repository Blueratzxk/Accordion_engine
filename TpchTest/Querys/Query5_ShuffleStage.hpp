...
#ifndef OLVP_QUERY5_SHUFFLESTAGE_HPP
#define OLVP_QUERY5_SHUFFLESTAGE_HPP
...
class Query5_ShuffleStage:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrders()
    {
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,filteredOrders);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrdersJoinLineitem(){
        ...
        shared_ptr<PartitioningScheme> schemeProbe222 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_HASH_SHUFFLE_STAGE_BUF"),{}));
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,tableScanLineitem);
  ...
  //      shared_ptr<PartitioningScheme> schemeProbe222 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_HASH_SHUFFLE_STAGE_BUF"),{}));
  //      ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,JoinLocalExchange);
...
#endif //OLVP_QUERY5_SHUFFLESTAGE_HPP
