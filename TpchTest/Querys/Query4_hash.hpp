...
#ifndef OLVP_QUERY4_HASH_HPP
#define OLVP_QUERY4_HASH_HPP
...
class Query4_hash:public RegQuery
{
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        shared_ptr<PartitioningScheme> partialAggExchangeScheme = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *partialAggExchange = new ExchangeNode("partialAggExchange",ExchangeNode::REPARTITION,partialAggExchangeScheme,paggLocalExchange2);
