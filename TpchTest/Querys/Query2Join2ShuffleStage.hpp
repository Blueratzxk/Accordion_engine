...
#define OLVP_QUERY2JOIN2SHUFFLESTAGE_HPP




#include "../../Query/RegQuery.h"
class Query2_Join2_ShuffleStage:public RegQuery
{

public:
    Query2_Join2_ShuffleStage(){
    ...
    LookupJoinNode *createLineitemJoinOrders()
    {
        ...
        shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_HASH_DISTRIBUTION_BUF"),{}));
...
#endif //OLVP_QUERY2JOIN2SHUFFLESTAGE_HPP
