...
#define OLVP_QUERY2_HASH_NL_HPP
...
class Query2_hash_NL:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNationJoinSupplierJoinPartsupp()
    {
        ...
        RNSPartsuppJoin->addProbe(probeExchange);
    ...
    LookupJoinNode *create2TJ_PartJoinPartsupp()
    {
        ...
        partPartsuppJoin->addProbe(probeExchange);
