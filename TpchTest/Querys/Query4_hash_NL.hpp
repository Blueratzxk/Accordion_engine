...
#ifndef OLVP_QUERY4_HASH_NL_HPP
#define OLVP_QUERY4_HASH_NL_HPP
...
class Query4_hash_NL:public RegQuery
{
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        ExchangeNode *partialAggExchange = new ExchangeNode("partialAggExchange",ExchangeNode::REPARTITION,partialAggExchangeScheme,partialAggLineitem);
