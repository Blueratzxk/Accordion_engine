...
#ifndef OLVP_QUERY4_SHUFFLESTAGE_HPP
#define OLVP_QUERY4_SHUFFLESTAGE_HPP
...
class Query4_ShuffleStage:public RegQuery
{
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        partialAggLineitem->addSource(paggLocalExchange1);
        ...
        ExchangeNode *partialAggExchange = new ExchangeNode("partialAggExchange",ExchangeNode::GATHER,partialAggExchangeScheme,paggLocalExchange2);
    ...
    LookupJoinNode *createOrdersJoinFinalAggLineitem(FinalAggregationNode *finalAggLineitem)
    {
     ...
     //   ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,forders);
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,forders);
        ...
        tableScanLocalExchange->addSource(probeExchange22);

        fOrdersFinalAggLineitemJoin->addProbe(tableScanLocalExchange);
        fOrdersFinalAggLineitemJoin->addBuild(buildExchange);
...
#endif //OLVP_QUERY4_SHUFFLESTAGE_HPP
