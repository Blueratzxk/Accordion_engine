...
#ifndef OLVP_QUERY7_SHUFFLESTAGE_HPP
#define OLVP_QUERY7_SHUFFLESTAGE_HPP
...
class Query7_ShuffleStage:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createFilteredNationJoinCustomerJoinOrders()
    {
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,tableScanOrders);
...
#endif //OLVP_QUERY7_SHUFFLESTAGE_HPP
