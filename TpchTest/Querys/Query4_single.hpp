...
#ifndef OLVP_QUERY4_SINGLE_HPP
#define OLVP_QUERY4_SINGLE_HPP
...
class Query4_single:public RegQuery
{
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        partialAggLineitem->addSource(lineitem);
    ...
    LookupJoinNode *createOrdersJoinFinalAggLineitem(FinalAggregationNode *finalAggLineitem)
    {
        ...
        fOrdersFinalAggLineitemJoin->addProbe(forders);
