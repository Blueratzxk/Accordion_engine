//
// Created by zxk on 9/28/23.
//

#ifndef OLVP_QUERY8_SHUFFLESTAGE_HPP
#define OLVP_QUERY8_SHUFFLESTAGE_HPP
...
class Query8_ShuffleStage:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createEightTJ()
    {
        ...
        shared_ptr<PartitioningScheme> schemeProbe2 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange22 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe2,joinLocalExchange2);
    ...
    LookupJoinNode *createFiveTJJoinPart() {
        ...
        shared_ptr<PartitioningScheme> schemeProbe2 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange22 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe2,joinLocalExchange);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrdersJoinLineitem(){
        ...
        LocalExchangeNode *probeLocalExchange = new LocalExchangeNode("probeLocalExchange");
        probeLocalExchange->addSource(probeExchange22);
...
#endif //OLVP_QUERY8_SHUFFLESTAGE_HPP
