//
// Created by zxk on 4/17/25.
//

#ifndef OLVP_QUERY1_NL_INTER_HPP
#define OLVP_QUERY1_NL_INTER_HPP
...
class Query1_NL_Inter:public RegQuery
{
...
public:
    ...
    */
        ...
        AggregationDesc FinalAggDesc({AggregateDesc(/*functionName=*/"hash_sum",/*inputKey=*/"partial_sum_qty",/*outputName=*/"sum_qty"),
                                      AggregateDesc(/*functionName=*/"hash_mean",/*inputKey=*/"sum_qty",/*outputName=*/"avg_qty"),
                                      AggregateDesc(/*functionName=*/"hash_sum",/*inputKey=*/"partial_sum_base_price",/*outputName=*/"sum_base_price"),
                                      AggregateDesc(/*functionName=*/"hash_mean",/*inputKey=*/"sum_base_price",/*outputName=*/"avg_price"),
                                      ...
                                      AggregateDesc(/*functionName=*/"hash_mean",/*inputKey=*/"sum_l_discount",/*outputName=*/"avg_disc"),
                                      AggregateDesc(/*functionName=*/"hash_sum",/*inputKey=*/"partial_count_order",/*outputName=*/"groupBy_count")
                                     },
                /*groupByKeys=*/{"l_returnflag","l_linestatus"});
    ...
    ProjectNode *createResultProject()
    {
        ...
        */
        ...
        assignments.addAssignment(FieldDesc("avg_qty","double"),FieldDesc("avg_qty","double"),NULL);

        assignments.addAssignment(FieldDesc("sum_base_price","double"),FieldDesc("sum_base_price","double"),NULL);
        assignments.addAssignment(FieldDesc("avg_price","double"),FieldDesc("avg_price","double"),NULL);
        ...
        assignments.addAssignment(FieldDesc("avg_disc","double"),FieldDesc("avg_disc","double"),NULL);

        assignments.addAssignment(FieldDesc("groupBy_count","int64"),FieldDesc::getEmptyDesc(),NULL);
...
#endif //OLVP_QUERY1_NL_INTER_HPP
