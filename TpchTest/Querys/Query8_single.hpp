...
#ifndef OLVP_QUERY8_SINGLE_HPP
#define OLVP_QUERY8_SINGLE_HPP
...
class Query8_single:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createEightTJ()
    {
        ...
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,sixTJ);
        ...
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,twoTJ);
    ...
    LookupJoinNode *createFiveTJJoinPart() {
        ...
        shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,fiveTJ);
        ...
        lookupJoinNode->addProbe(fiveTJ);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrdersJoinLineitem(){
        ...
        lookupJoinNode->addProbe(tableScanLineitem);
        lookupJoinNode->addBuild(buildExchange);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrders()
    {
        ...
        RJNJCJOJoin->addProbe(filteredOrders);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomer()
    {
        ...
        RJNJCJoin->addProbe(tableScanCustomer);
