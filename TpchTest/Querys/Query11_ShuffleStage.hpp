...
#define OLVP_QUERY11_SHUFFLESTAGE_HPP
...
class Query11_ShuffleStage:public RegQuery
{

public:
    Query11_ShuffleStage(){
    ...
    PlanNode* getPlanTree()
    {
        ...
        ExchangeNode *exchange = new ExchangeNode("schemeExchange",ExchangeNode::GATHER,schemeExchange,localExchange);
    ...
    PlanNode *createCrossjoin()
    {
        ...
        ExchangeNode *exchange1 = new ExchangeNode("exchange1",ExchangeNode::GATHER,scheme1,paggLocalExchange1);
        ...
        ExchangeNode *exchange2 = new ExchangeNode("exchange2",ExchangeNode::GATHER,scheme2,paggLocalExchange2);
        ...
        crossJoin->addProbe(probeLocalExchange);
    ...
    ProjectNode *createProjectNodeSubQuery()
    {
        ...
        Column *ps_supplycost = new Column("0","ps_supplycost","double");
        Column *ps_availqty  = new Column("0","ps_availqty","int64");
        DoubleLiteral *faction = new DoubleLiteral("0","0.0001");
    ...
    LookupJoinNode *createFilteredNationJoinSupplierJoinPartsupp()
    {
        ...
        shared_ptr<PartitioningScheme> schemeProbe3 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange3 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe3,tableScanPartSupp);
        ...
        ExchangeNode *probeExchange= new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,probeExchange3);
    ...
    FilterNode *createTableScanNationAndFilter1() {
        ...
        StringLiteral *n_nameValue = new StringLiteral("0","CHINA");
...
#endif //OLVP_QUERY11_SHUFFLESTAGE_HPP
