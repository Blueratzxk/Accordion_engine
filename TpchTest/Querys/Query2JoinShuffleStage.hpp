//
// Created by zxk on 5/22/24.
//

#ifndef OLVP_QUERY2JOINSHUFFLESTAGE_HPP
#define OLVP_QUERY2JOINSHUFFLESTAGE_HPP

#include "../../Query/RegQuery.h"
class Query2_Join_ShuffleStage:public RegQuery
{

public:
    Query2_Join_ShuffleStage(){
    ...
    LookupJoinNode *createLineitemJoinOrders()
    {
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("buildExchange",ExchangeNode::REPARTITION,schemeProbe222,tableScanOrders);
        ...
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPARTITION,schemeBuild,probeExchange222);
...
#endif //OLVP_QUERY2JOINSHUFFLESTAGE_HPP
