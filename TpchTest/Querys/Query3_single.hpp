...
#ifndef OLVP_QUERY3_SINGLE_HPP
#define OLVP_QUERY3_SINGLE_HPP
...
class Query3_single:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createCustomerJoinOrders()
    {
        ...
        customerOrdersJoin->addProbe(filteredOrders);
    ...
    LookupJoinNode *create3TJ()
    {
        ...
        buildLocalExchange->addSource(customerJoinOrders);
        ...
        customerOrdersJoin->addProbe(filteredLineitem);
        customerOrdersJoin->addBuild(buildExchange);
