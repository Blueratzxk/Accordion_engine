...
#ifndef OLVP_QUERY12_SHUFFLESTAGE_HPP
#define OLVP_QUERY12_SHUFFLESTAGE_HPP
...
class Query12_ShuffleStage:public RegQuery
{

public:
    Query12_ShuffleStage(){
    ...
    PlanNode* getPlanTree()
    {
        ...
        ExchangeNode *exchange = new ExchangeNode("exchange",ExchangeNode::GATHER,scheme1,paggLocalExchange);
    ...
    LookupJoinNode *createOrdersJoinFilterLineitem()
    {
        ...
        shared_ptr<PartitioningScheme> schemeProbe2 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_HASH_SHUFFLE_STAGE_BUF"),{}));
        ExchangeNode *probeExchange22 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe2,fLineitem);


        shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_HASH_SHUFFLE_STAGE_BUF"),{}),outputLayout,hashColumnProbe,bucketToPartition);
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,probeExchange22);
...
#endif //OLVP_QUERY12_SHUFFLESTAGE_HPP
