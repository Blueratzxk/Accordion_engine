...
#ifndef OLVP_QUERY5_SINGLE_HPP
#define OLVP_QUERY5_SINGLE_HPP
...
class Query5_single:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNation()
    {
        ...
        RNJoin->addProbe(tableScanNation);
    ...
    LookupJoinNode *create4TJSupplier(){
        ...
        lookupJoinNode->addProbe(RJNJCJOJL);
        lookupJoinNode->addBuild(buildExchange);
