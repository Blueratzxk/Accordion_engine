...
#ifndef OLVP_QUERY7_SINGLE_HPP
#define OLVP_QUERY7_SINGLE_HPP
...
class Query7_single:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createFilteredNationJoinCustomer()
    {
        ...
        Join->addProbe(tableScanCustomer);
        Join->addBuild(buildExchange);
    ...
    LookupJoinNode *createFilteredNationJoinSupplierJoinLineitem() {
        ...
        Join->addProbe(tableScanLineitem);
        Join->addBuild(buildExchange);
