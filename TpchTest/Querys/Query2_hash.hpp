//
// Created by zxk on 9/15/23.
//

#ifndef OLVP_QUERY2_HASH_HPP
#define OLVP_QUERY2_HASH_HPP
...
class Query2_hash:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNationJoinSupplierJoinPartsupp()
    {
        ...
        PartsuppLocalExchange->addSource(probeExchange);
    ...
    LookupJoinNode *create2TJ_PartJoinPartsupp()
    {
        ...
        partsuppProbeLocalExchange->addSource(probeExchange);
