...
#ifndef OLVP_QUERY9_HPP
#define OLVP_QUERY9_HPP
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        ExchangeNode *exchange = new ExchangeNode("exchange",ExchangeNode::GATHER,scheme2,LocalExchangePagg);
    ...
    PlanNode *createLineitemJoinFilteredPart()
    {
        ...
        lookupJoinNode->addProbe(LocalExchangeProbe);
    ...
    ProjectNode *createOrdersTableScanAndFilter()
    {
        ...
        projectNode->addSource(filterOrders);
