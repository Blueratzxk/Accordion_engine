...
#ifndef OLVP_QUERY3_HPP
#define OLVP_QUERY3_HPP
...
public:
    ...
    LookupJoinNode *createCustomerJoinOrders()
    {
        ...
        customerOrdersJoin->addProbe(tableScanLocalExchange);
    ...
    LookupJoinNode *create3TJ()
    {
        ...
        shared_ptr<PartitioningScheme> schemeBuild = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("FIXED_BROADCAST_DISTRIBUTION"),{}));
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,buildLocalExchange);
