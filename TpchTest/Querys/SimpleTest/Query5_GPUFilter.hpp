...
#ifndef OLVP_QUERY5_GPUFILTER_HPP
#define OLVP_QUERY5_GPUFILTER_HPP
...
class Query5_GPUFilter:public RegQuery
{
...
public:
    ...
    PlanNode* getPlanTree()
    {
        ...
        ExchangeNode *exchange = new ExchangeNode("exchange",ExchangeNode::GATHER,scheme2,patialAgg);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomer()
    {
        ...
        shared_ptr<PartitioningScheme> schemeBuild = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("FIXED_BROADCAST_DISTRIBUTION"),{}));
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,RJN);
        ...
        RJNJCJoin->addProbe(probeExchange);
    ...
    {
        PlanNode *RJNJC = this->createRegionJoinNationJoinCustomer();
        TableScanNode *OrdersTable = createOrdersTableScan();
        ...
        shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,OrdersTable);

        shared_ptr<PartitioningScheme> schemeBuild = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("FIXED_BROADCAST_DISTRIBUTION"),{}));
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,RJNJC);
        ...
        Date32Literal *date32Literalup = new Date32Literal("0","1994-01-01");
        ...
        Date32Literal *date32Literaldown = new Date32Literal("0","1994-01-01");
        ...
        filterOrders->addSource(probeExchange);

        RJNJCJOJoin->addProbe(filterOrders);
    ...
    LookupJoinNode *createRegionJoinNationJoinCustomerJoinOrdersJoinLineitem(){
        ...
        shared_ptr<PartitioningScheme> schemeBuild = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("FIXED_BROADCAST_DISTRIBUTION"),{}));
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange",ExchangeNode::REPLICATE,schemeBuild,RJNJCJO);
    ...
    LookupJoinNode *create4TJSupplier(){
        ...
        shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_DISTRIBUTION_BUF"),{}));
        ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,RJNJCJOJL);
...
#endif //OLVP_QUERY5_GPUFILTER_HPP
