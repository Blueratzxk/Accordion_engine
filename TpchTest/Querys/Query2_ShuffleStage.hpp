...
#ifndef OLVP_QUERY2_SHUFFLESTAGE_HPP
#define OLVP_QUERY2_SHUFFLESTAGE_HPP
...
class Query2_ShuffleStage:public RegQuery
{
...
public:
    ...
    LookupJoinNode *createRegionJoinNationJoinSupplierJoinPartsupp()
    {
        ...
        regionNationJoin->addProbe(nationLocalExchange);
        ...
        ExchangeNode *buildExchange2 = new ExchangeNode("buildExchange222",ExchangeNode::REPLICATE,schemeBuild2,regionNationJoinLocalExchange);
        ...
        RNSupplierJoin->addProbe(supplierLocalExchange);
        ...
        shared_ptr<PartitioningScheme> schemeBuild3 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_HASH_REDISTRIBUTION_BUF"),{}),outputLayout,hashColumnBuild,bucketToPartition);
        ExchangeNode *buildExchange3 = new ExchangeNode("buildExchange333",ExchangeNode::REPLICATE,schemeBuild3,RNSupplierJoinLocalExchange);
        //----------------------------------join partsupp------------------------------------------------------------------------//
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange1",ExchangeNode::REPARTITION,schemeProbe,tableScanPartsupp);
     ...
     //   shared_ptr<PartitioningScheme> schemeProbe222 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_HASH_SHUFFLE_STAGE_BUF"),{}));
       // ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,tableScanPartsupp);
        ...
        ExchangeNode *probeExchange22 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe22,probeExchange222);
        ...
        PartsuppLocalExchange->addSource(probeExchange22);


        RNSPartsuppJoin->addProbe(PartsuppLocalExchange);
    ...
    LookupJoinNode *create3TJ_RegionJoinNationJoinSupplier()
    {
        ...
        regionNationJoin->addBuild(buildExchange1);
        regionNationJoin->addProbe(nationProbeLocalExchange);
        ...
        shared_ptr<PartitioningScheme> schemeBuild2 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("FIXED_BROADCAST_DISTRIBUTION"),{}));
        ExchangeNode *buildExchange2 = new ExchangeNode("buildExchange555",ExchangeNode::REPLICATE,schemeBuild2,NJoinRLocalExchange);
        ...
        RNSupplierJoin->addProbe(supplierProbeLocalExchange);
        RNSupplierJoin->addBuild(buildExchange2);
    ...
    //    ExchangeNode *probeExchange = new ExchangeNode("probeExchange1",ExchangeNode::REPARTITION,schemeProbe,tableScanPartsupp);
      ...
      //  ExchangeNode *probeExchange = new ExchangeNode("probeExchange1",ExchangeNode::REPARTITION,schemeProbe,tableScanPartsupp);
        ...
        partsuppProbeLocalExchange->addSource(probeExchange22);

        partPartsuppJoin->addProbe(partsuppProbeLocalExchange);
    ...
    LookupJoinNode *create5TJ()
    {
        ...
        ExchangeNode *buildExchange = new ExchangeNode("buildExchange777",ExchangeNode::REPLICATE,schemeBuild,threeBuildLocalExchange);
        ...
        fiveTJJoin->addProbe(twoJoinLocalExchange);
...
#endif //OLVP_QUERY2_SHUFFLESTAGE_HPP
