...
#ifndef OLVP_QUERY10_SHUFFLESTAGE_HPP
#define OLVP_QUERY10_SHUFFLESTAGE_HPP
...
class Query10_ShuffleStage:public RegQuery
{

public:
    Query10_ShuffleStage(){
    ...
    LookupJoinNode *createCustomerJoinNation()
    {
      ...
      //  shared_ptr<PartitioningScheme> schemeProbe = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_HASH_DISTRIBUTION_BUF"),{}),outputLayout,hashColumnProbe,bucketToPartition);
       // ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,customer);
        ...
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,customer);
  ...
  //      ExchangeNode *probeExchange = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe,flineitem);
        ...
        shared_ptr<PartitioningScheme> schemeProbe222 = make_shared<PartitioningScheme>(Partitioning::create(SystemPartitioningHandle::get("SCALED_SIMPLE_HASH_SHUFFLE_STAGE_BUF"),{}));
        ExchangeNode *probeExchange222 = new ExchangeNode("probeExchange",ExchangeNode::REPARTITION,schemeProbe222,flineitem);
...
#endif //OLVP_QUERY10_SHUFFLESTAGE_HPP
