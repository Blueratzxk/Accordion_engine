...
#ifndef OLVP_QUERY2JOIN_NL_SMALLORDERS_HPP
#define OLVP_QUERY2JOIN_NL_SMALLORDERS_HPP
...
class Query2_Join_NL_SmallOrders:public RegQuery
{

public:
    Query2_Join_NL_SmallOrders(){
...
#endif //OLVP_QUERY2JOIN_NL_SMALLORDERS_HPP
