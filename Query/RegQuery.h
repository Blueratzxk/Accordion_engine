...
public:
    ...
    static string Q2()
    {
        ...
        sql.append("and p_size = 30\n");
        sql.append("and p_type like '%MEDIUM%' \n");
        sql.append("and s_nationkey = n_nationkey\n");
        sql.append("and n_regionkey = r_regionkey\n");
        sql.append("and r_name = 'AMERICA'\n");
    ...
    static string Q3()
    {
        ...
        sql.append("where\n");
        sql.append("c_mktsegment = 'BUILDING' \n");
        sql.append("and c_custkey = o_custkey\n");
        sql.append("and l_orderkey = o_orderkey\n");
        sql.append("and o_orderdate < date '1995-03-21' \n");
        sql.append("and l_shipdate > date '1995-01-21'\n");
        sql.append(" group by\n");
        sql.append("l_orderkey,\n");
        sql.append("o_orderdate,\n");
        sql.append("o_shippriority\n");
    ...
    static string Q4()
    {
        ...
        sql.append("where\n");
        sql.append("o_orderdate >= date '1995-03-21'\n");
        sql.append("and o_orderdate < date '1995-09-21' + interval '3' month\n");
    ...
    static string Q5()
    {
        ...
        sql.append("and n_regionkey = r_regionkey\n");
        sql.append("and r_name = 'AMERICA'\n");
        sql.append("and o_orderdate >= date '1995-09-21' \n");
        sql.append("and o_orderdate < date '1995-09-21' + interval '1' year\n");
        sql.append("group by \n");
        sql.append("n_name\n");
        sql.append("order by \n");
        sql.append("revenue desc;\n");
    ...
    static string Q6()
    {
        ...
        sql.append("lineitem\n");
        sql.append("where\n");
        sql.append("l_shipdate >= date '1995-09-21' \n");
        sql.append("and l_shipdate < date '1995-09-21' + interval '1' year\n");
        sql.append("and l_discount between 0.01 - 0.01 and 0.01 + 0.01 \n");
        sql.append("and l_quantity < 24; \n");
        return sql;
    }
    static string Q7()
    {
        ...
        sql.append("and (\n");
        sql.append("(n1.n_name = 'CANADA' and n2.n_name = 'CHINA')\n");
        sql.append("or (n1.n_name = 'CHINA' and n2.n_name = 'CANADA')\n");
        sql.append(")\n");
    ...
    static string Q8()
    {
        ...
        sql.append(" and p_type = 'LARGE BRUSHED BRASS'\n");
    ...
    static string Q9()
    {
        ...
        sql.append("and o_orderkey = l_orderkey\n");
        sql.append("and s_nationkey = n_nationkey\n");
        sql.append("and p_name like '%aquamarine drab dim antique sky%'\n");
    ...
    static string Q10()
    {
        ...
        sql.append("c_custkey = o_custkey\n");
        sql.append("and l_orderkey = o_orderkey\n");
        sql.append("and o_orderdate >= date '1995-01-01'\n");
        sql.append("and o_orderdate < date '1996-12-31' + interval '3' month\n");
    ...
    static string Q11()
    {
        ...
        sql.append("and s_nationkey = n_nationkey\n");
        sql.append("and n_name = 'FRANCE'\n");
        sql.append("group by\n");
        sql.append("ps_partkey having\n");
        sql.append("sum(ps_supplycost * ps_availqty) > ( \n");
        sql.append("select\n");
        sql.append("sum(ps_supplycost * ps_availqty) * 0.000001 \n");
        sql.append("from\n");
        sql.append("partsupp, supplier, nation\n");
        sql.append("where \n");
        sql.append("ps_suppkey = s_suppkey\n");
    ...
    static string Q12()
    {
        ...
        sql.append("and l_shipmode in ('AIR', 'TRUCK') \n");
        sql.append("and l_commitdate < l_receiptdate\n");
        sql.append("and l_shipdate < l_commitdate\n");
        sql.append("and l_receiptdate >= date '1995-03-21' \n");
        sql.append("and l_receiptdate < date '1995-09-21' + interval '1' year\n");
        sql.append("group by \n");
        sql.append("l_shipmode\n");
        sql.append("order by\n");
        sql.append("l_shipmode;\n");
