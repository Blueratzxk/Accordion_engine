...
#ifndef OLVP_OUTPUTPARTITIONINGBUFFER_HPP
#define OLVP_OUTPUTPARTITIONINGBUFFER_HPP
...
class OutputPartitioningBuffer: public OutputBuffer
{
...
public:
    ...
    void addTaskContext(shared_ptr<TaskContext> taskContext){
        ...
        this->tbg->addTaskContext(this->taskContext);
    }
    ...
    void changeBufferSize()
    {
      ...
      //  this->pageNumsLimit = 10;
        spdlog::debug("OutputPartitioningBuffer size is changed! Now the size is "+ to_string(this->pageNumsLimit)+"!");
    }
...
#endif //OLVP_OUTPUTPARTITIONINGBUFFER_HPP
